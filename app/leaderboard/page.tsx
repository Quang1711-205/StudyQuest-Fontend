    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <main className="md:ml-20 xl:ml-64 mt-16 p-4 md:p-8 transition-all duration-300">
        <div className="max-w-6xl mx-auto">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-semibold text-amber-600 dark:text-amber-500">#10</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-semibold text-teal-600 dark:text-teal-400 flex items-center">
                      +3
                      <Zap className="w-5 h-5 ml-1 text-yellow-500" />
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-semibold text-purple-600 dark:text-purple-400">1.2M</div>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Leaderboard Tabs */}
          <Tabs defaultValue="global" className="w-full">
            <TabsList className="grid w-full md:w-auto md:inline-grid grid-cols-3 mb-6 h-12 bg-white dark:bg-slate-800 p-1">
              <TabsTrigger 
                value="global" 
              ...
              <TabsTrigger 
                value="friends" 
                className="gap-2 text-sm font-medium data-[state=active]:bg-teal-500 data-[state=active]:text-white"
              >
                <Users className="w-4 h-4" />
                <span className="hidden sm:inline">Friends</span>
              </TabsTrigger>
            ...
            <TabsContent value="friends">
              <Card className="border-2 border-teal-100 dark:border-teal-900/30">
                <CardHeader className="bg-teal-50 dark:bg-teal-950/30 border-b">
                  <CardTitle className="text-xl font-semibold flex items-center gap-2">
